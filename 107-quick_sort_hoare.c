...
/**
 * hoare_partition - Perform Hoare partition for Quick Sort.
...
/**
 * hoare_sort - Implement the Quick Sort algorithm using Hoare's scheme.
 ...
 * order using the Quick Sort algorithm (Hoare's scheme.
 * @array: Array to sort.
 * @size: Size of the array.
 *
 */
